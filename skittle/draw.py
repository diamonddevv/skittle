...
def circle(ctx: moderngl.Context, camera: skittle.camera.Camera, origin: glm.vec2, radius: float, color: skittle.color.Color, filled: bool = True, fill_col: skittle.color.Color | None = None, outline_width: float = 1.0, layer: int = 0, overlay: bool = False):
